...
- В брауезере при открытии напрямую как `file:///...` таблица результатов может не отображаться из-за ограничений безопасности для локальных файлов (особенно при пути с кириллицей).
